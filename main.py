...
API_KEY = "PK9AUP82FBJ5UXH06SFG"
API_SECRET = "Si3gLDrjfmbglau8Cdi4K7pn94oKAUIGIcrTxyYf"
...
class TradingBot:
    def __init__(self, symbol: str, take_profit_pct, stop_loss_pct, cash_at_risk: float = 0.1): 
        ...
        self.analytics = Analytics(symbol, start_=(datetime.now() - timedelta(days=365)).strftime('%Y-%m-%d'), end_=datetime.now().strftime('%Y-%m-%d'))
    ...
    def trade(self):
        ...
        valuation = self.analytics.get_valuation()
